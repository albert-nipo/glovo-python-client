...
class SchedulingApi(object):
    ...
    def active_temporary_closing(self, store_id, **kwargs):  # noqa: E501
        """Active temporary closing  # noqa: E501

        Allows you to get an active store temporary closure if any.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.active_temporary_closing(store_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.active_temporary_closing_with_http_info(store_id, **kwargs)  # noqa: E501
        else:
            (data) = self.active_temporary_closing_with_http_info(store_id, **kwargs)  # noqa: E501
            return data

    def active_temporary_closing_with_http_info(self, store_id, **kwargs):  # noqa: E501
        """Active temporary closing  # noqa: E501

        Allows you to get an active store temporary closure if any.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.active_temporary_closing_with_http_info(store_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method active_temporary_closing" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('store_id' not in params or
            ...
            raise ValueError("Missing the required parameter `store_id` when calling `active_temporary_closing`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/webhook/stores/{storeId}/closing', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def close_temporaly(self, content_type, store_id, **kwargs):  # noqa: E501
        """Close temporaly  # noqa: E501

        Allows you to close a store temporarily until a specified date and time in the future. This will ignore the opening times defined in the store schedule, forcing the store to be closed until the specified date and time.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.close_temporaly(content_type, store_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str content_type: Specify that the content will be sent as JSON (required)
        :param str store_id: [Unique identifier of the store](#section/Getting-started/Unique-identifier-of-the-store)  (required)
        :param StoreIdClosingBody body:
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.close_temporaly_with_http_info(content_type, store_id, **kwargs)  # noqa: E501
        else:
            (data) = self.close_temporaly_with_http_info(content_type, store_id, **kwargs)  # noqa: E501
            return data

    def close_temporaly_with_http_info(self, content_type, store_id, **kwargs):  # noqa: E501
        """Close temporaly  # noqa: E501

        Allows you to close a store temporarily until a specified date and time in the future. This will ignore the opening times defined in the store schedule, forcing the store to be closed until the specified date and time.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.close_temporaly_with_http_info(content_type, store_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('content_type' not in params or
            ...
            raise ValueError("Missing the required parameter `content_type` when calling `close_temporaly`")  # noqa: E501
        # verify the required parameter 'store_id' is set
        if ('store_id' not in params or
                params['store_id'] is None):
            raise ValueError("Missing the required parameter `store_id` when calling `close_temporaly`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/webhook/stores/{storeId}/closing', 'PUT',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def remove_close_temporaly(self, store_id, **kwargs):  # noqa: E501
        """Remove temporary closing  # noqa: E501

        Allows you to remove an active temporary closure for a store. After the removal, the store will continue following their regular schedule.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_close_temporaly(store_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.remove_close_temporaly_with_http_info(store_id, **kwargs)  # noqa: E501
        else:
            (data) = self.remove_close_temporaly_with_http_info(store_id, **kwargs)  # noqa: E501
            return data

    def remove_close_temporaly_with_http_info(self, store_id, **kwargs):  # noqa: E501
        """Remove temporary closing  # noqa: E501

        Allows you to remove an active temporary closure for a store. After the removal, the store will continue following their regular schedule.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.remove_close_temporaly_with_http_info(store_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method remove_close_temporaly" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'store_id' is set
        if ('store_id' not in params or
                params['store_id'] is None):
            raise ValueError("Missing the required parameter `store_id` when calling `remove_close_temporaly`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/webhook/stores/{storeId}/closing', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def store_schedule(self, store_id, **kwargs):  # noqa: E501
        """Schedule  # noqa: E501

        Allows you to get the current schedule for a particular store.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_schedule(store_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.store_schedule_with_http_info(store_id, **kwargs)  # noqa: E501
        else:
            (data) = self.store_schedule_with_http_info(store_id, **kwargs)  # noqa: E501
            return data

    def store_schedule_with_http_info(self, store_id, **kwargs):  # noqa: E501
        """Schedule  # noqa: E501

        Allows you to get the current schedule for a particular store.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.store_schedule_with_http_info(store_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('store_id' not in params or
                params['store_id'] is None):
            raise ValueError("Missing the required parameter `store_id` when calling `store_schedule`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/webhook/stores/{storeId}/schedule', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='StoreSchedule',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
