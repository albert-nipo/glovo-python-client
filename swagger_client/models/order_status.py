...
class OrderStatus(object):
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["ACCEPTED", "READY_FOR_PICKUP", "OUT_FOR_DELIVERY", "PICKED_UP_BY_CUSTOMER"]  # noqa: E501
