...
class ModifyOrderAttributes(object):
    ...
    def __init__(self, id=None, quantity=None):  # noqa: E501
        """ModifyOrderAttributes - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._quantity = None
    ...
    @property
    def id(self):
        """Gets the id of this ModifyOrderAttributes.  # noqa: E501

        Unique identifier of the attribute within a store  # noqa: E501

        :return: The id of this ModifyOrderAttributes.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ModifyOrderAttributes.

        Unique identifier of the attribute within a store  # noqa: E501

        :param id: The id of this ModifyOrderAttributes.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def quantity(self):
        """Gets the quantity of this ModifyOrderAttributes.  # noqa: E501

        Attribute quantity  # noqa: E501

        :return: The quantity of this ModifyOrderAttributes.  # noqa: E501
        :rtype: int
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this ModifyOrderAttributes.

        Attribute quantity  # noqa: E501

        :param quantity: The quantity of this ModifyOrderAttributes.  # noqa: E501
        :type: int
        """
        if quantity is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModifyOrderAttributes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyOrderAttributes):
            return False
