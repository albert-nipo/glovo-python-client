...
class ModifyOrderReplacements(object):
    ...
    def __init__(self, purchased_product_id=None, product=None):  # noqa: E501
        """ModifyOrderReplacements - a model defined in Swagger"""  # noqa: E501
    ...
    def purchased_product_id(self):
        """Gets the purchased_product_id of this ModifyOrderReplacements.  # noqa: E501

        Unique identifier of the purchased product (`purchased_product_id`) that *will be replaced* in the original order   # noqa: E501

        :return: The purchased_product_id of this ModifyOrderReplacements.  # noqa: E501
        :rtype: str
        """
    ...
    def purchased_product_id(self, purchased_product_id):
        """Sets the purchased_product_id of this ModifyOrderReplacements.

        Unique identifier of the purchased product (`purchased_product_id`) that *will be replaced* in the original order   # noqa: E501

        :param purchased_product_id: The purchased_product_id of this ModifyOrderReplacements.  # noqa: E501
        :type: str
        """
    ...
    @property
    def product(self):
        """Gets the product of this ModifyOrderReplacements.  # noqa: E501


        :return: The product of this ModifyOrderReplacements.  # noqa: E501
        :rtype: ModifyOrderProduct
        """
        return self._product

    @product.setter
    def product(self, product):
        """Sets the product of this ModifyOrderReplacements.


        :param product: The product of this ModifyOrderReplacements.  # noqa: E501
        :type: ModifyOrderProduct
        """
        if product is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModifyOrderReplacements, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyOrderReplacements):
            return False
