...
class OrderProducts(object):
    ...
    swagger_types = {
        ...
        'price': 'int',
        'name': 'str',
        'attributes': 'list[OrderAttributes]'
    }
    ...
    def __init__(self, id=None, purchased_product_id=None, quantity=None, price=None, name=None, attributes=None):  # noqa: E501
        ...
        self.id = id
        self.purchased_product_id = purchased_product_id
    ...
    @property
    def id(self):
        """Gets the id of this OrderProducts.  # noqa: E501

        Unique identifier of the product within a store  # noqa: E501

        :return: The id of this OrderProducts.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @property
    def purchased_product_id(self):
        """Gets the purchased_product_id of this OrderProducts.  # noqa: E501

        Unique identifier of every individual selection of a (potentially customized) product within the order. This identifier is necessary to perform order modifications over the products purchased.   # noqa: E501

        :return: The purchased_product_id of this OrderProducts.  # noqa: E501
        :rtype: str
        """
        return self._purchased_product_id

    @purchased_product_id.setter
    def purchased_product_id(self, purchased_product_id):
        """Sets the purchased_product_id of this OrderProducts.

        Unique identifier of every individual selection of a (potentially customized) product within the order. This identifier is necessary to perform order modifications over the products purchased.   # noqa: E501

        :param purchased_product_id: The purchased_product_id of this OrderProducts.  # noqa: E501
        :type: str
        """
        if purchased_product_id is None:
            raise ValueError("Invalid value for `purchased_product_id`, must not be `None`")  # noqa: E501

        self._purchased_product_id = purchased_product_id
    ...
    def price(self):
        ...
        Product unit price (without attributes) in cents  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this OrderProducts.  # noqa: E501

        Product name  # noqa: E501

        :return: The name of this OrderProducts.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this OrderProducts.

        Product name  # noqa: E501

        :param name: The name of this OrderProducts.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def attributes(self):
        """Gets the attributes of this OrderProducts.  # noqa: E501

        Attributes associated with the given product  # noqa: E501

        :return: The attributes of this OrderProducts.  # noqa: E501
        :rtype: list[OrderAttributes]
        """
        return self._attributes

    @attributes.setter
    def attributes(self, attributes):
        """Sets the attributes of this OrderProducts.

        Attributes associated with the given product  # noqa: E501

        :param attributes: The attributes of this OrderProducts.  # noqa: E501
        :type: list[OrderAttributes]
        """
