...
class OrderCustomer(object):
    ...
    swagger_types = {
        ...
        'phone_number': 'str',
        'hash': 'str',
        'invoicing_details': 'OrderCustomerInvoicingDetails'
    }
    ...
    def __init__(self, name=None, phone_number=None, hash=None, invoicing_details=None):  # noqa: E501
        """OrderCustomer - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._phone_number = None
        self._hash = None
        self._invoicing_details = None
        ...
        if hash is not None:
            self.hash = hash
        if invoicing_details is not None:
            self.invoicing_details = invoicing_details

    @property
    def name(self):
        """Gets the name of this OrderCustomer.  # noqa: E501

        Customer name  # noqa: E501

        :return: The name of this OrderCustomer.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this OrderCustomer.

        Customer name  # noqa: E501

        :param name: The name of this OrderCustomer.  # noqa: E501
        :type: str
        """
    ...
    def phone_number(self):
        """Gets the phone_number of this OrderCustomer.  # noqa: E501

        Customer phone number. Relevant to [marketplace orders](#section/Getting-started/Marketplace-orders) only.  For Glovo orders this will be set to `\"N/A\"`   # noqa: E501

        :return: The phone_number of this OrderCustomer.  # noqa: E501
        :rtype: str
        """
    ...
    def phone_number(self, phone_number):
        """Sets the phone_number of this OrderCustomer.

        Customer phone number. Relevant to [marketplace orders](#section/Getting-started/Marketplace-orders) only.  For Glovo orders this will be set to `\"N/A\"`   # noqa: E501

        :param phone_number: The phone_number of this OrderCustomer.  # noqa: E501
        :type: str
        """
    ...
    @property
    def hash(self):
        """Gets the hash of this OrderCustomer.  # noqa: E501

        Unique identifier of the customer  # noqa: E501

        :return: The hash of this OrderCustomer.  # noqa: E501
        :rtype: str
        """
        return self._hash
    ...
    @hash.setter
    def hash(self, hash):
        """Sets the hash of this OrderCustomer.

        Unique identifier of the customer  # noqa: E501

        :param hash: The hash of this OrderCustomer.  # noqa: E501
        :type: str
        """
    ...
    def invoicing_details(self):
        """Gets the invoicing_details of this OrderCustomer.  # noqa: E501


        :return: The invoicing_details of this OrderCustomer.  # noqa: E501
        :rtype: OrderCustomerInvoicingDetails
        """
        return self._invoicing_details

    @invoicing_details.setter
    def invoicing_details(self, invoicing_details):
        """Sets the invoicing_details of this OrderCustomer.


        :param invoicing_details: The invoicing_details of this OrderCustomer.  # noqa: E501
        :type: OrderCustomerInvoicingDetails
        """

        self._invoicing_details = invoicing_details
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrderCustomer, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrderCustomer):
            return False
