...
class BulkUpdateItems(object):
    ...
    """
    swagger_types = {
        'products': 'list[BulkUpdateItemsProducts]',
        'attributes': 'list[BulkUpdateItemsAttributes]'
    }
    ...
    def __init__(self, products=None, attributes=None):  # noqa: E501
        """BulkUpdateItems - a model defined in Swagger"""  # noqa: E501
        self._products = None
    ...
    @property
    def products(self):
        """Gets the products of this BulkUpdateItems.  # noqa: E501

        Products to be updated.  # noqa: E501

        :return: The products of this BulkUpdateItems.  # noqa: E501
        :rtype: list[BulkUpdateItemsProducts]
        """
        return self._products

    @products.setter
    def products(self, products):
        """Sets the products of this BulkUpdateItems.

        Products to be updated.  # noqa: E501

        :param products: The products of this BulkUpdateItems.  # noqa: E501
        :type: list[BulkUpdateItemsProducts]
        """
    ...
    @property
    def attributes(self):
        """Gets the attributes of this BulkUpdateItems.  # noqa: E501

        Attributes to be updated.  # noqa: E501

        :return: The attributes of this BulkUpdateItems.  # noqa: E501
        :rtype: list[BulkUpdateItemsAttributes]
        """
        return self._attributes

    @attributes.setter
    def attributes(self, attributes):
        """Sets the attributes of this BulkUpdateItems.

        Attributes to be updated.  # noqa: E501

        :param attributes: The attributes of this BulkUpdateItems.  # noqa: E501
        :type: list[BulkUpdateItemsAttributes]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkUpdateItems, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkUpdateItems):
            return False
