...
class ModifyAttributeResult(object):
    ...
    def __init__(self, id=None, name=None, selected_by_default=None, price=None, available=None):  # noqa: E501
        """ModifyAttributeResult - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
    ...
    @property
    def id(self):
        """Gets the id of this ModifyAttributeResult.  # noqa: E501

        Unique identifier of the attribute within a store  # noqa: E501

        :return: The id of this ModifyAttributeResult.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ModifyAttributeResult.

        Unique identifier of the attribute within a store  # noqa: E501

        :param id: The id of this ModifyAttributeResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ModifyAttributeResult.  # noqa: E501

        Attribute name  # noqa: E501

        :return: The name of this ModifyAttributeResult.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ModifyAttributeResult.

        Attribute name  # noqa: E501

        :param name: The name of this ModifyAttributeResult.  # noqa: E501
        :type: str
        """
    ...
    def selected_by_default(self):
        """Gets the selected_by_default of this ModifyAttributeResult.  # noqa: E501

        Specifies if the attribute should be selected by default when customizing the product associated  # noqa: E501

        :return: The selected_by_default of this ModifyAttributeResult.  # noqa: E501
        :rtype: bool
        """
    ...
    def selected_by_default(self, selected_by_default):
        """Sets the selected_by_default of this ModifyAttributeResult.

        Specifies if the attribute should be selected by default when customizing the product associated  # noqa: E501

        :param selected_by_default: The selected_by_default of this ModifyAttributeResult.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def price(self):
        """Gets the price of this ModifyAttributeResult.  # noqa: E501

        Attribute price  # noqa: E501

        :return: The price of this ModifyAttributeResult.  # noqa: E501
        :rtype: str
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this ModifyAttributeResult.

        Attribute price  # noqa: E501

        :param price: The price of this ModifyAttributeResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def available(self):
        """Gets the available of this ModifyAttributeResult.  # noqa: E501

        Specifies if the product is available to be purchased  # noqa: E501

        :return: The available of this ModifyAttributeResult.  # noqa: E501
        :rtype: bool
        """
    ...
    def available(self, available):
        """Sets the available of this ModifyAttributeResult.

        Specifies if the product is available to be purchased  # noqa: E501

        :param available: The available of this ModifyAttributeResult.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModifyAttributeResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyAttributeResult):
            return False
