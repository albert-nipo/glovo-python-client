...
class BulkUpdateItemsStatus(object):
    ...
    def __init__(self, transaction_id=None, status=None, last_updated_at=None, details=None):  # noqa: E501
        """BulkUpdateItemsStatus - a model defined in Swagger"""  # noqa: E501
    ...
    def transaction_id(self):
        """Gets the transaction_id of this BulkUpdateItemsStatus.  # noqa: E501

        Unique identifier of the asynchronous operation  # noqa: E501

        :return: The transaction_id of this BulkUpdateItemsStatus.  # noqa: E501
        :rtype: str
        """
    ...
    def transaction_id(self, transaction_id):
        """Sets the transaction_id of this BulkUpdateItemsStatus.

        Unique identifier of the asynchronous operation  # noqa: E501

        :param transaction_id: The transaction_id of this BulkUpdateItemsStatus.  # noqa: E501
        :type: str
        """
    ...
    @property
    def status(self):
        """Gets the status of this BulkUpdateItemsStatus.  # noqa: E501

        Current status of the bulk update  # noqa: E501

        :return: The status of this BulkUpdateItemsStatus.  # noqa: E501
        :rtype: str
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this BulkUpdateItemsStatus.

        Current status of the bulk update  # noqa: E501

        :param status: The status of this BulkUpdateItemsStatus.  # noqa: E501
        :type: str
        """
        allowed_values = ["SUCCESS", "PROCESSING", "PARTIALLY_PROCESSED", "NOT_PROCESSED", "GLOVO_ERROR"]  # noqa: E501
    ...
    def last_updated_at(self):
        """Gets the last_updated_at of this BulkUpdateItemsStatus.  # noqa: E501

        Timestamp of the lastest menu status update  # noqa: E501

        :return: The last_updated_at of this BulkUpdateItemsStatus.  # noqa: E501
        :rtype: str
        """
    ...
    def last_updated_at(self, last_updated_at):
        """Sets the last_updated_at of this BulkUpdateItemsStatus.

        Timestamp of the lastest menu status update  # noqa: E501

        :param last_updated_at: The last_updated_at of this BulkUpdateItemsStatus.  # noqa: E501
        :type: str
        """
    ...
    @property
    def details(self):
        """Gets the details of this BulkUpdateItemsStatus.  # noqa: E501

        Details for the current menu status  # noqa: E501

        :return: The details of this BulkUpdateItemsStatus.  # noqa: E501
        :rtype: list
        """
    ...
    def details(self, details):
        """Sets the details of this BulkUpdateItemsStatus.

        Details for the current menu status  # noqa: E501

        :param details: The details of this BulkUpdateItemsStatus.  # noqa: E501
        :type: list
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(BulkUpdateItemsStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BulkUpdateItemsStatus):
            return False
