...
class MenuRestrictions(object):
    ...
    def __init__(self, is_alcoholic=None, is_tobacco=None):  # noqa: E501
        """MenuRestrictions - a model defined in Swagger"""  # noqa: E501
        self._is_alcoholic = None
        self._is_tobacco = None
        self.discriminator = None
        if is_alcoholic is not None:
            self.is_alcoholic = is_alcoholic
        if is_tobacco is not None:
            self.is_tobacco = is_tobacco

    @property
    def is_alcoholic(self):
        """Gets the is_alcoholic of this MenuRestrictions.  # noqa: E501

        Flag indicating if the product is an alcoholic beverage.  # noqa: E501

        :return: The is_alcoholic of this MenuRestrictions.  # noqa: E501
        :rtype: bool
        """
    ...
    def is_alcoholic(self, is_alcoholic):
        """Sets the is_alcoholic of this MenuRestrictions.

        Flag indicating if the product is an alcoholic beverage.  # noqa: E501

        :param is_alcoholic: The is_alcoholic of this MenuRestrictions.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def is_tobacco(self):
        """Gets the is_tobacco of this MenuRestrictions.  # noqa: E501

        Flag indicating if the product is a tobacco product.  # noqa: E501

        :return: The is_tobacco of this MenuRestrictions.  # noqa: E501
        :rtype: bool
        """
        return self._is_tobacco

    @is_tobacco.setter
    def is_tobacco(self, is_tobacco):
        """Sets the is_tobacco of this MenuRestrictions.

        Flag indicating if the product is a tobacco product.  # noqa: E501

        :param is_tobacco: The is_tobacco of this MenuRestrictions.  # noqa: E501
        :type: bool
        """

        self._is_tobacco = is_tobacco
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MenuRestrictions, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MenuRestrictions):
            return False
