...
class StoreIdMenuBody(object):
    ...
    def __init__(self, menu_url=None):  # noqa: E501
        """StoreIdMenuBody - a model defined in Swagger"""  # noqa: E501
        self._menu_url = None
    ...
    @property
    def menu_url(self):
        """Gets the menu_url of this StoreIdMenuBody.  # noqa: E501

        URL to a JSON resource following the format specified in [Menu model](#tag/Menu-model).  We will request the JSON resource sending the header `Authorization: Bearer your-secret-token`  It is important that all the URL can be accessible from any IP address.   # noqa: E501

        :return: The menu_url of this StoreIdMenuBody.  # noqa: E501
        :rtype: str
        """
    ...
    def menu_url(self, menu_url):
        """Sets the menu_url of this StoreIdMenuBody.

        URL to a JSON resource following the format specified in [Menu model](#tag/Menu-model).  We will request the JSON resource sending the header `Authorization: Bearer your-secret-token`  It is important that all the URL can be accessible from any IP address.   # noqa: E501

        :param menu_url: The menu_url of this StoreIdMenuBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoreIdMenuBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StoreIdMenuBody):
            return False
