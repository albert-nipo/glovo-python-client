...
class MenuCollections(object):
    ...
    def __init__(self, name=None, position=None, image_url=None, sections=None):  # noqa: E501
        """MenuCollections - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._position = None
    ...
    @property
    def name(self):
        """Gets the name of this MenuCollections.  # noqa: E501

        Collection name. It should be unique as it will serve as identifier of the collection.  # noqa: E501

        :return: The name of this MenuCollections.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MenuCollections.

        Collection name. It should be unique as it will serve as identifier of the collection.  # noqa: E501

        :param name: The name of this MenuCollections.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def position(self):
        """Gets the position of this MenuCollections.  # noqa: E501

        Relative position of the collection in the menu  # noqa: E501

        :return: The position of this MenuCollections.  # noqa: E501
        :rtype: int
        """
    ...
    def position(self, position):
        """Sets the position of this MenuCollections.

        Relative position of the collection in the menu  # noqa: E501

        :param position: The position of this MenuCollections.  # noqa: E501
        :type: int
        """
    ...
    @property
    def image_url(self):
        """Gets the image_url of this MenuCollections.  # noqa: E501

        Url of the collection image. Must use HTTPS protocol.  # noqa: E501

        :return: The image_url of this MenuCollections.  # noqa: E501
        :rtype: str
        """
    ...
    def image_url(self, image_url):
        """Sets the image_url of this MenuCollections.

        Url of the collection image. Must use HTTPS protocol.  # noqa: E501

        :param image_url: The image_url of this MenuCollections.  # noqa: E501
        :type: str
        """
    ...
    @property
    def sections(self):
        """Gets the sections of this MenuCollections.  # noqa: E501

        A section is a subdivision within a collection. Any collection must contain at least one section with at least one product associated.   # noqa: E501

        :return: The sections of this MenuCollections.  # noqa: E501
        :rtype: list[MenuSections]
        """
        return self._sections

    @sections.setter
    def sections(self, sections):
        """Sets the sections of this MenuCollections.

        A section is a subdivision within a collection. Any collection must contain at least one section with at least one product associated.   # noqa: E501

        :param sections: The sections of this MenuCollections.  # noqa: E501
        :type: list[MenuSections]
        """
        if sections is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MenuCollections, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MenuCollections):
            return False
