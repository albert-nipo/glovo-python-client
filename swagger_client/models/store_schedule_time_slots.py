...
class StoreScheduleTimeSlots(object):
    ...
    def __init__(self, opening=None, closing=None):  # noqa: E501
        """StoreScheduleTimeSlots - a model defined in Swagger"""  # noqa: E501
        self._opening = None
        self._closing = None
    ...
    @property
    def opening(self):
        """Gets the opening of this StoreScheduleTimeSlots.  # noqa: E501

        Starting time of the slot in the format `HH:mm`  # noqa: E501

        :return: The opening of this StoreScheduleTimeSlots.  # noqa: E501
        :rtype: str
        """
    ...
    def opening(self, opening):
        """Sets the opening of this StoreScheduleTimeSlots.

        Starting time of the slot in the format `HH:mm`  # noqa: E501

        :param opening: The opening of this StoreScheduleTimeSlots.  # noqa: E501
        :type: str
        """
    ...
    @property
    def closing(self):
        """Gets the closing of this StoreScheduleTimeSlots.  # noqa: E501

        Ending time of the slot in the format `HH:mm`  # noqa: E501

        :return: The closing of this StoreScheduleTimeSlots.  # noqa: E501
        :rtype: str
        """
    ...
    def closing(self, closing):
        """Sets the closing of this StoreScheduleTimeSlots.

        Ending time of the slot in the format `HH:mm`  # noqa: E501

        :param closing: The closing of this StoreScheduleTimeSlots.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoreScheduleTimeSlots, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StoreScheduleTimeSlots):
            return False
