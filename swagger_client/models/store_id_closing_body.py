...
class StoreIdClosingBody(object):
    ...
    def __init__(self, until=None):  # noqa: E501
        """StoreIdClosingBody - a model defined in Swagger"""  # noqa: E501
        self._until = None
    ...
    @property
    def until(self):
        """Gets the until of this StoreIdClosingBody.  # noqa: E501

        A date-time in the future with an offset from UTC/Greenwich in the ISO-8601 calendar system.  # noqa: E501

        :return: The until of this StoreIdClosingBody.  # noqa: E501
        :rtype: str
        """
        return self._until
    ...
    def until(self, until):
        """Sets the until of this StoreIdClosingBody.

        A date-time in the future with an offset from UTC/Greenwich in the ISO-8601 calendar system.  # noqa: E501

        :param until: The until of this StoreIdClosingBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoreIdClosingBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StoreIdClosingBody):
            return False
