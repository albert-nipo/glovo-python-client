...
class OrderAttributes(object):
    ...
    def __init__(self, id=None, quantity=None, price=None, name=None):  # noqa: E501
        """OrderAttributes - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._quantity = None
        self._price = None
        self._name = None
    ...
    @property
    def id(self):
        """Gets the id of this OrderAttributes.  # noqa: E501

        Unique identifier of the attribute within a store  # noqa: E501

        :return: The id of this OrderAttributes.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this OrderAttributes.

        Unique identifier of the attribute within a store  # noqa: E501

        :param id: The id of this OrderAttributes.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def quantity(self):
        """Gets the quantity of this OrderAttributes.  # noqa: E501

        Attribute quantity  # noqa: E501

        :return: The quantity of this OrderAttributes.  # noqa: E501
        :rtype: int
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this OrderAttributes.

        Attribute quantity  # noqa: E501

        :param quantity: The quantity of this OrderAttributes.  # noqa: E501
        :type: int
        """
        if quantity is None:
    ...
    @property
    def price(self):
        """Gets the price of this OrderAttributes.  # noqa: E501

        Attribute unit price in cents  # noqa: E501

        :return: The price of this OrderAttributes.  # noqa: E501
        :rtype: int
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this OrderAttributes.

        Attribute unit price in cents  # noqa: E501

        :param price: The price of this OrderAttributes.  # noqa: E501
        :type: int
        """
        if price is None:
    ...
    @property
    def name(self):
        """Gets the name of this OrderAttributes.  # noqa: E501

        Attribute name  # noqa: E501

        :return: The name of this OrderAttributes.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this OrderAttributes.

        Attribute name  # noqa: E501

        :param name: The name of this OrderAttributes.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrderAttributes, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrderAttributes):
            return False
