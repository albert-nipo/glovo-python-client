...
class ModifyOrderProduct(object):
    ...
    swagger_types = {
        'id': 'str',
        'quantity': 'int',
        'attributes': 'list[ModifyOrderProductAttributes]'
    }
    ...
    def __init__(self, id=None, quantity=None, attributes=None):  # noqa: E501
        """ModifyOrderProduct - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._quantity = None
    ...
    @property
    def id(self):
        """Gets the id of this ModifyOrderProduct.  # noqa: E501

        Unique identifier of the product within a store  # noqa: E501

        :return: The id of this ModifyOrderProduct.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ModifyOrderProduct.

        Unique identifier of the product within a store  # noqa: E501

        :param id: The id of this ModifyOrderProduct.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def quantity(self):
        """Gets the quantity of this ModifyOrderProduct.  # noqa: E501

        Product quantity  # noqa: E501

        :return: The quantity of this ModifyOrderProduct.  # noqa: E501
        :rtype: int
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this ModifyOrderProduct.

        Product quantity  # noqa: E501

        :param quantity: The quantity of this ModifyOrderProduct.  # noqa: E501
        :type: int
        """
        if quantity is None:
    ...
    @property
    def attributes(self):
        """Gets the attributes of this ModifyOrderProduct.  # noqa: E501

        List of attributes associated with the replaced product  # noqa: E501

        :return: The attributes of this ModifyOrderProduct.  # noqa: E501
        :rtype: list[ModifyOrderProductAttributes]
        """
        return self._attributes

    @attributes.setter
    def attributes(self, attributes):
        """Sets the attributes of this ModifyOrderProduct.

        List of attributes associated with the replaced product  # noqa: E501

        :param attributes: The attributes of this ModifyOrderProduct.  # noqa: E501
        :type: list[ModifyOrderProductAttributes]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModifyOrderProduct, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyOrderProduct):
            return False
