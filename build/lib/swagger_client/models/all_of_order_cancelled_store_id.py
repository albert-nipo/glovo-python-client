...
import six
from swagger_client.models.store_id import StoreId  # noqa: F401,E501

class AllOfOrderCancelledStoreId(StoreId):
    ...
    if hasattr(StoreId, "swagger_types"):
        swagger_types.update(StoreId.swagger_types)

    attribute_map = {
    }
    if hasattr(StoreId, "attribute_map"):
        attribute_map.update(StoreId.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfOrderCancelledStoreId - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        StoreId.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfOrderCancelledStoreId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfOrderCancelledStoreId):
            return False
