...
class InlineResponse200(object):
    ...
    @property
    def until(self):
        """Gets the until of this InlineResponse200.  # noqa: E501

        A date-time in the future with an offset from UTC/Greenwich in the ISO-8601 calendar system. If there is no active temporary closing this value will be set to null.  # noqa: E501

        :return: The until of this InlineResponse200.  # noqa: E501
        :rtype: str
        """
        return self._until
    ...
    def until(self, until):
        """Sets the until of this InlineResponse200.

        A date-time in the future with an offset from UTC/Greenwich in the ISO-8601 calendar system. If there is no active temporary closing this value will be set to null.  # noqa: E501

        :param until: The until of this InlineResponse200.  # noqa: E501
        :type: str
        """
