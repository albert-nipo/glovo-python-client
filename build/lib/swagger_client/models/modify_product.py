...
class ModifyProduct(object):
    ...
    def __init__(self, price=None, available=None):  # noqa: E501
        """ModifyProduct - a model defined in Swagger"""  # noqa: E501
        self._price = None
    ...
    @property
    def price(self):
        """Gets the price of this ModifyProduct.  # noqa: E501

        The new product price in the store. If the value is not present or is null, it will not be updated.  # noqa: E501

        :return: The price of this ModifyProduct.  # noqa: E501
        :rtype: float
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this ModifyProduct.

        The new product price in the store. If the value is not present or is null, it will not be updated.  # noqa: E501

        :param price: The price of this ModifyProduct.  # noqa: E501
        :type: float
        """
    ...
    @property
    def available(self):
        """Gets the available of this ModifyProduct.  # noqa: E501

        Flag indicating if the product is available in the store. If the value is not present or is null, it will not be updated.  # noqa: E501

        :return: The available of this ModifyProduct.  # noqa: E501
        :rtype: bool
        """
    ...
    def available(self, available):
        """Sets the available of this ModifyProduct.

        Flag indicating if the product is available in the store. If the value is not present or is null, it will not be updated.  # noqa: E501

        :param available: The available of this ModifyProduct.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModifyProduct, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyProduct):
            return False
