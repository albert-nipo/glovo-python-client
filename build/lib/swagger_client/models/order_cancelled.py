...
class OrderCancelled(object):
    ...
    def __init__(self, order_id=None, store_id=None, cancel_reason=None, payment_strategy=None):  # noqa: E501
        """OrderCancelled - a model defined in Swagger"""  # noqa: E501
        self._order_id = None
        self._store_id = None
    ...
    @property
    def order_id(self):
        """Gets the order_id of this OrderCancelled.  # noqa: E501


        :return: The order_id of this OrderCancelled.  # noqa: E501
        :rtype: AllOfOrderCancelledOrderId
        """
        return self._order_id

    @order_id.setter
    def order_id(self, order_id):
        """Sets the order_id of this OrderCancelled.


        :param order_id: The order_id of this OrderCancelled.  # noqa: E501
        :type: AllOfOrderCancelledOrderId
        """
        if order_id is None:
    ...
    @property
    def store_id(self):
        """Gets the store_id of this OrderCancelled.  # noqa: E501


        :return: The store_id of this OrderCancelled.  # noqa: E501
        :rtype: AllOfOrderCancelledStoreId
        """
        return self._store_id

    @store_id.setter
    def store_id(self, store_id):
        """Sets the store_id of this OrderCancelled.


        :param store_id: The store_id of this OrderCancelled.  # noqa: E501
        :type: AllOfOrderCancelledStoreId
        """
        if store_id is None:
    ...
    def cancel_reason(self):
        """Gets the cancel_reason of this OrderCancelled.  # noqa: E501

        Description of order cancellation reason  - `PRODUCTS_NOT_AVAILABLE`: Products are not available in store - `STORE_CAN_NOT_DELIVER`: Order could not be delivered by partner - `PARTNER_PRINTER_ISSUE`: Order cancelled due to issues with partner's device - `USER_ERROR`: Customer has cancelled the order - `ORDER_NOT_FEASIBLE`: It is impossible to fulfill the customer's request - `OTHER`: Other cancellation reasons that do not fall into the above categories   # noqa: E501

        :return: The cancel_reason of this OrderCancelled.  # noqa: E501
        :rtype: str
        """
    ...
    def cancel_reason(self, cancel_reason):
        """Sets the cancel_reason of this OrderCancelled.

        Description of order cancellation reason  - `PRODUCTS_NOT_AVAILABLE`: Products are not available in store - `STORE_CAN_NOT_DELIVER`: Order could not be delivered by partner - `PARTNER_PRINTER_ISSUE`: Order cancelled due to issues with partner's device - `USER_ERROR`: Customer has cancelled the order - `ORDER_NOT_FEASIBLE`: It is impossible to fulfill the customer's request - `OTHER`: Other cancellation reasons that do not fall into the above categories   # noqa: E501

        :param cancel_reason: The cancel_reason of this OrderCancelled.  # noqa: E501
        :type: str
        """
        if cancel_reason is None:
            raise ValueError("Invalid value for `cancel_reason`, must not be `None`")  # noqa: E501
        allowed_values = ["PRODUCTS_NOT_AVAILABLE", "STORE_CAN_NOT_DELIVER", "PARTNER_PRINTER_ISSUE", "USER_ERROR", "ORDER_NOT_FEASIBLE", "OTHER"]  # noqa: E501
        if cancel_reason not in allowed_values:
            raise ValueError(
                "Invalid value for `cancel_reason` ({0}), must be one of {1}"  # noqa: E501
                .format(cancel_reason, allowed_values)
            )

        self._cancel_reason = cancel_reason

    @property
    def payment_strategy(self):
        """Gets the payment_strategy of this OrderCancelled.  # noqa: E501

        - `PAY_NOTHING`: Glovo will not pay the partner for the order products - `PAY_PRODUCTS`: Glovo will pay the partner for the order products   # noqa: E501

        :return: The payment_strategy of this OrderCancelled.  # noqa: E501
        :rtype: str
        """
        return self._payment_strategy

    @payment_strategy.setter
    def payment_strategy(self, payment_strategy):
        """Sets the payment_strategy of this OrderCancelled.

        - `PAY_NOTHING`: Glovo will not pay the partner for the order products - `PAY_PRODUCTS`: Glovo will pay the partner for the order products   # noqa: E501

        :param payment_strategy: The payment_strategy of this OrderCancelled.  # noqa: E501
        :type: str
        """
        allowed_values = ["PAY_NOTHING", "PAY_PRODUCTS"]  # noqa: E501
        if payment_strategy not in allowed_values:
            raise ValueError(
                "Invalid value for `payment_strategy` ({0}), must be one of {1}"  # noqa: E501
                .format(payment_strategy, allowed_values)
            )
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrderCancelled, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OrderCancelled):
            return False
