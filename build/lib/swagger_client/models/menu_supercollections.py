...
class MenuSupercollections(object):
    ...
    def __init__(self, name=None, position=None, image_url=None, collections=None):  # noqa: E501
        """MenuSupercollections - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._position = None
    ...
    @property
    def name(self):
        """Gets the name of this MenuSupercollections.  # noqa: E501

        Super collection name  # noqa: E501

        :return: The name of this MenuSupercollections.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MenuSupercollections.

        Super collection name  # noqa: E501

        :param name: The name of this MenuSupercollections.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def position(self):
        """Gets the position of this MenuSupercollections.  # noqa: E501

        Relative position of the super collection in the menu  # noqa: E501

        :return: The position of this MenuSupercollections.  # noqa: E501
        :rtype: int
        """
    ...
    def position(self, position):
        """Sets the position of this MenuSupercollections.

        Relative position of the super collection in the menu  # noqa: E501

        :param position: The position of this MenuSupercollections.  # noqa: E501
        :type: int
        """
    ...
    @property
    def image_url(self):
        """Gets the image_url of this MenuSupercollections.  # noqa: E501

        Url of the super collection image. Must use HTTPS protocol.  # noqa: E501

        :return: The image_url of this MenuSupercollections.  # noqa: E501
        :rtype: str
        """
    ...
    def image_url(self, image_url):
        """Sets the image_url of this MenuSupercollections.

        Url of the super collection image. Must use HTTPS protocol.  # noqa: E501

        :param image_url: The image_url of this MenuSupercollections.  # noqa: E501
        :type: str
        """
    ...
    def collections(self):
        """Gets the collections of this MenuSupercollections.  # noqa: E501

        List of collection names that would be part of the super collection. Collections will be displayed in the order of the list.  # noqa: E501

        :return: The collections of this MenuSupercollections.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def collections(self, collections):
        """Sets the collections of this MenuSupercollections.

        List of collection names that would be part of the super collection. Collections will be displayed in the order of the list.  # noqa: E501

        :param collections: The collections of this MenuSupercollections.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MenuSupercollections, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MenuSupercollections):
            return False
