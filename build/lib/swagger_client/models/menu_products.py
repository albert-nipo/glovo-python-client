...
class MenuProducts(object):
    ...
    def __init__(self, id=None, name=None, price=None, image_url=None, extra_image_urls=None, restrictions=None, description=None, attributes_groups=None, available=None):  # noqa: E501
        """MenuProducts - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
        self._price = None
        self._image_url = None
        self._extra_image_urls = None
        ...
        if extra_image_urls is not None:
            self.extra_image_urls = extra_image_urls
    ...
    @property
    def id(self):
        """Gets the id of this MenuProducts.  # noqa: E501

        Unique identifier of the product within a store  # noqa: E501

        :return: The id of this MenuProducts.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this MenuProducts.

        Unique identifier of the product within a store  # noqa: E501

        :param id: The id of this MenuProducts.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def name(self):
        """Gets the name of this MenuProducts.  # noqa: E501

        Product name  # noqa: E501

        :return: The name of this MenuProducts.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MenuProducts.

        Product name  # noqa: E501

        :param name: The name of this MenuProducts.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def price(self):
        """Gets the price of this MenuProducts.  # noqa: E501

        Product price  # noqa: E501

        :return: The price of this MenuProducts.  # noqa: E501
        :rtype: float
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this MenuProducts.

        Product price  # noqa: E501

        :param price: The price of this MenuProducts.  # noqa: E501
        :type: float
        """
        if price is None:
    ...
    @property
    def image_url(self):
        """Gets the image_url of this MenuProducts.  # noqa: E501

        Url of the main product image. Must use HTTPS protocol.  # noqa: E501

        :return: The image_url of this MenuProducts.  # noqa: E501
        :rtype: str
        """
    ...
    def image_url(self, image_url):
        """Sets the image_url of this MenuProducts.

        Url of the main product image. Must use HTTPS protocol.  # noqa: E501

        :param image_url: The image_url of this MenuProducts.  # noqa: E501
        :type: str
        """
    ...
    def extra_image_urls(self):
        """Gets the extra_image_urls of this MenuProducts.  # noqa: E501

        Array of urls of product extra images. Must use HTTPS protocol.  They will be displayed in the product detail page in the same order as in the array, and always after the main image. Support up to 9 images (if more images are sent, the first 9 will be processed).   # noqa: E501

        :return: The extra_image_urls of this MenuProducts.  # noqa: E501
        :rtype: list[str]
        """
        return self._extra_image_urls

    @extra_image_urls.setter
    def extra_image_urls(self, extra_image_urls):
        """Sets the extra_image_urls of this MenuProducts.

        Array of urls of product extra images. Must use HTTPS protocol.  They will be displayed in the product detail page in the same order as in the array, and always after the main image. Support up to 9 images (if more images are sent, the first 9 will be processed).   # noqa: E501

        :param extra_image_urls: The extra_image_urls of this MenuProducts.  # noqa: E501
        :type: list[str]
        """

        self._extra_image_urls = extra_image_urls

    @property
    def restrictions(self):
        """Gets the restrictions of this MenuProducts.  # noqa: E501


        :return: The restrictions of this MenuProducts.  # noqa: E501
        :rtype: MenuRestrictions
        """
        return self._restrictions

    @restrictions.setter
    def restrictions(self, restrictions):
        """Sets the restrictions of this MenuProducts.


        :param restrictions: The restrictions of this MenuProducts.  # noqa: E501
    ...
    def description(self):
        """Gets the description of this MenuProducts.  # noqa: E501

        Product description  # noqa: E501

        :return: The description of this MenuProducts.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this MenuProducts.

        Product description  # noqa: E501

        :param description: The description of this MenuProducts.  # noqa: E501
        :type: str
        """
    ...
    def attributes_groups(self):
        """Gets the attributes_groups of this MenuProducts.  # noqa: E501

        List of attribute group unique identifiers that would be part of the product. Attribute groups will be displayed in the order of the list.  # noqa: E501

        :return: The attributes_groups of this MenuProducts.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def attributes_groups(self, attributes_groups):
        """Sets the attributes_groups of this MenuProducts.

        List of attribute group unique identifiers that would be part of the product. Attribute groups will be displayed in the order of the list.  # noqa: E501

        :param attributes_groups: The attributes_groups of this MenuProducts.  # noqa: E501
        :type: list[str]
        """
    ...
    @property
    def available(self):
        """Gets the available of this MenuProducts.  # noqa: E501

        Specifies if the product is available to be purchased  # noqa: E501

        :return: The available of this MenuProducts.  # noqa: E501
        :rtype: bool
        """
    ...
    def available(self, available):
        """Sets the available of this MenuProducts.

        Specifies if the product is available to be purchased  # noqa: E501

        :param available: The available of this MenuProducts.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MenuProducts, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MenuProducts):
            return False
