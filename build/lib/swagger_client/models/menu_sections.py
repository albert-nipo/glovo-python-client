...
class MenuSections(object):
    ...
    def __init__(self, name=None, position=None, products=None):  # noqa: E501
        """MenuSections - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._position = None
        self._products = None
    ...
    @property
    def name(self):
        """Gets the name of this MenuSections.  # noqa: E501

        Section name  # noqa: E501

        :return: The name of this MenuSections.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MenuSections.

        Section name  # noqa: E501

        :param name: The name of this MenuSections.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def position(self):
        """Gets the position of this MenuSections.  # noqa: E501

        Relative position of the section in the collection  # noqa: E501

        :return: The position of this MenuSections.  # noqa: E501
        :rtype: int
        """
    ...
    def position(self, position):
        """Sets the position of this MenuSections.

        Relative position of the section in the collection  # noqa: E501

        :param position: The position of this MenuSections.  # noqa: E501
        :type: int
        """
    ...
    @property
    def products(self):
        """Gets the products of this MenuSections.  # noqa: E501

        List of products unique identifiers that would be part of the section. Products will be displayed in the order of the list.  # noqa: E501

        :return: The products of this MenuSections.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def products(self, products):
        """Sets the products of this MenuSections.

        List of products unique identifiers that would be part of the section. Products will be displayed in the order of the list.  # noqa: E501

        :param products: The products of this MenuSections.  # noqa: E501
        :type: list[str]
        """
        if products is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(MenuSections, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MenuSections):
            return False
