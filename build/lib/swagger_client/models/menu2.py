...
class Menu2(object):
    ...
    """
    swagger_types = {
        'attributes': 'list[MenuAttributes]',
        'attribute_groups': 'list[MenuAttributeGroups]',
        'products': 'list[MenuProducts]',
        'collections': 'list[MenuCollections]',
        'supercollections': 'list[MenuSupercollections]'
    }
    ...
    def __init__(self, attributes=None, attribute_groups=None, products=None, collections=None, supercollections=None):  # noqa: E501
        """Menu2 - a model defined in Swagger"""  # noqa: E501
        self._attributes = None
        self._attribute_groups = None
        self._products = None
        self._collections = None
        self._supercollections = None
        ...
        if supercollections is not None:
            self.supercollections = supercollections

    @property
    def attributes(self):
        """Gets the attributes of this Menu2.  # noqa: E501

        A product can be customized in different ways e.g. add mayonnaise, bundle it with a drink, or add extra meat.  Each of these customizations is considered an attribute. It is not mandatory for a product to have attributes.  Each attribute can have a different price impact. Similar attributes are grouped into attribute groups.   # noqa: E501

        :return: The attributes of this Menu2.  # noqa: E501
        :rtype: list[MenuAttributes]
        """
        return self._attributes

    @attributes.setter
    def attributes(self, attributes):
        """Sets the attributes of this Menu2.

        A product can be customized in different ways e.g. add mayonnaise, bundle it with a drink, or add extra meat.  Each of these customizations is considered an attribute. It is not mandatory for a product to have attributes.  Each attribute can have a different price impact. Similar attributes are grouped into attribute groups.   # noqa: E501

        :param attributes: The attributes of this Menu2.  # noqa: E501
        :type: list[MenuAttributes]
        """
    ...
    def attribute_groups(self):
        """Gets the attribute_groups of this Menu2.  # noqa: E501

        Attribute groups allow to group similar customizations into generic groups. Each attribute group can have a minimum and maximum of choices for the customer. Examples of attribute groups could include: - Sauces: a group of attributes such as mayo, mustard or tomato sauce - Drinks: a group of attributes such as water, coke, or lemonade   # noqa: E501

        :return: The attribute_groups of this Menu2.  # noqa: E501
        :rtype: list[MenuAttributeGroups]
        """
        return self._attribute_groups

    @attribute_groups.setter
    def attribute_groups(self, attribute_groups):
        """Sets the attribute_groups of this Menu2.

        Attribute groups allow to group similar customizations into generic groups. Each attribute group can have a minimum and maximum of choices for the customer. Examples of attribute groups could include: - Sauces: a group of attributes such as mayo, mustard or tomato sauce - Drinks: a group of attributes such as water, coke, or lemonade   # noqa: E501

        :param attribute_groups: The attribute_groups of this Menu2.  # noqa: E501
        :type: list[MenuAttributeGroups]
        """
    ...
    @property
    def products(self):
        """Gets the products of this Menu2.  # noqa: E501

        A product is the main component of a Glovo menu. It usually represents a physical product in a store, although we give stores flexibility to configure what they want to offer as products. Each product belongs in a section.   # noqa: E501

        :return: The products of this Menu2.  # noqa: E501
        :rtype: list[MenuProducts]
        """
        return self._products

    @products.setter
    def products(self, products):
        """Sets the products of this Menu2.

        A product is the main component of a Glovo menu. It usually represents a physical product in a store, although we give stores flexibility to configure what they want to offer as products. Each product belongs in a section.   # noqa: E501

        :param products: The products of this Menu2.  # noqa: E501
        :type: list[MenuProducts]
        """
    ...
    def collections(self):
        """Gets the collections of this Menu2.  # noqa: E501

        A collection is the main categorization of a Glovo menu. It is mandatory to have at least one collection in your menu. It is composed by sections and it must have at least one to contain other elements.  Some examples of collections include: Drinks, Burgers, Salads, Desserts, Pasta.   # noqa: E501

        :return: The collections of this Menu2.  # noqa: E501
        :rtype: list[MenuCollections]
        """
        return self._collections

    @collections.setter
    def collections(self, collections):
        """Sets the collections of this Menu2.

        A collection is the main categorization of a Glovo menu. It is mandatory to have at least one collection in your menu. It is composed by sections and it must have at least one to contain other elements.  Some examples of collections include: Drinks, Burgers, Salads, Desserts, Pasta.   # noqa: E501

        :param collections: The collections of this Menu2.  # noqa: E501
        :type: list[MenuCollections]
        """

        self._collections = collections

    @property
    def supercollections(self):
        """Gets the supercollections of this Menu2.  # noqa: E501

        A super collection is the uppermost categorization of a Glovo menu. Super collections are not required. If at least one exists, a list of all the super collections is displayed to customers when they open a store in the app. Otherwise, the collection is displayed as the uppermost categorization.   # noqa: E501

        :return: The supercollections of this Menu2.  # noqa: E501
        :rtype: list[MenuSupercollections]
        """
        return self._supercollections

    @supercollections.setter
    def supercollections(self, supercollections):
        """Sets the supercollections of this Menu2.

        A super collection is the uppermost categorization of a Glovo menu. Super collections are not required. If at least one exists, a list of all the super collections is displayed to customers when they open a store in the app. Otherwise, the collection is displayed as the uppermost categorization.   # noqa: E501

        :param supercollections: The supercollections of this Menu2.  # noqa: E501
        :type: list[MenuSupercollections]
        """

        self._supercollections = supercollections
