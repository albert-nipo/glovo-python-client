...
import six
from swagger_client.models.order_id import OrderId  # noqa: F401,E501

class AllOfOrderCancelledOrderId(OrderId):
    ...
    if hasattr(OrderId, "swagger_types"):
        swagger_types.update(OrderId.swagger_types)

    attribute_map = {
    }
    if hasattr(OrderId, "attribute_map"):
        attribute_map.update(OrderId.attribute_map)

    def __init__(self, *args, **kwargs):  # noqa: E501
        """AllOfOrderCancelledOrderId - a model defined in Swagger"""  # noqa: E501
        self.discriminator = None
        OrderId.__init__(self, *args, **kwargs)
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfOrderCancelledOrderId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfOrderCancelledOrderId):
            return False
