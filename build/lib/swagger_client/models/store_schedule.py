...
class StoreSchedule(object):
    ...
    swagger_types = {
        'timezone': 'str',
        'schedule': 'list[StoreScheduleSchedule]'
    }
    ...
    def __init__(self, timezone=None, schedule=None):  # noqa: E501
        """StoreSchedule - a model defined in Swagger"""  # noqa: E501
        self._timezone = None
        self._schedule = None
    ...
    @property
    def timezone(self):
        """Gets the timezone of this StoreSchedule.  # noqa: E501

        Timezone of the store based on its city.  # noqa: E501

        :return: The timezone of this StoreSchedule.  # noqa: E501
        :rtype: str
        """
    ...
    def timezone(self, timezone):
        """Sets the timezone of this StoreSchedule.

        Timezone of the store based on its city.  # noqa: E501

        :param timezone: The timezone of this StoreSchedule.  # noqa: E501
        :type: str
        """
    ...
    @property
    def schedule(self):
        """Gets the schedule of this StoreSchedule.  # noqa: E501

        Array of Day Schedule objects containing the weekly schedule of the store.  # noqa: E501

        :return: The schedule of this StoreSchedule.  # noqa: E501
        :rtype: list[StoreScheduleSchedule]
        """
        return self._schedule

    @schedule.setter
    def schedule(self, schedule):
        """Sets the schedule of this StoreSchedule.

        Array of Day Schedule objects containing the weekly schedule of the store.  # noqa: E501

        :param schedule: The schedule of this StoreSchedule.  # noqa: E501
        :type: list[StoreScheduleSchedule]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(StoreSchedule, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StoreSchedule):
            return False
