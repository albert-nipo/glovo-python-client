...
class ModifyProductResult(object):
    ...
    def __init__(self, id=None, name=None, price=None, image_url=None, description=None, available=None):  # noqa: E501
        """ModifyProductResult - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
        self._price = None
    ...
    @property
    def id(self):
        """Gets the id of this ModifyProductResult.  # noqa: E501

        Unique identifier of the attribute within a store  # noqa: E501

        :return: The id of this ModifyProductResult.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ModifyProductResult.

        Unique identifier of the attribute within a store  # noqa: E501

        :param id: The id of this ModifyProductResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this ModifyProductResult.  # noqa: E501

        Product name  # noqa: E501

        :return: The name of this ModifyProductResult.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ModifyProductResult.

        Product name  # noqa: E501

        :param name: The name of this ModifyProductResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def price(self):
        """Gets the price of this ModifyProductResult.  # noqa: E501

        Product price  # noqa: E501

        :return: The price of this ModifyProductResult.  # noqa: E501
        :rtype: str
        """
        return self._price
    ...
    def price(self, price):
        """Sets the price of this ModifyProductResult.

        Product price  # noqa: E501

        :param price: The price of this ModifyProductResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def image_url(self):
        """Gets the image_url of this ModifyProductResult.  # noqa: E501

        Url of the main product image. Must use HTTPS protocol.  # noqa: E501

        :return: The image_url of this ModifyProductResult.  # noqa: E501
        :rtype: str
        """
    ...
    def image_url(self, image_url):
        """Sets the image_url of this ModifyProductResult.

        Url of the main product image. Must use HTTPS protocol.  # noqa: E501

        :param image_url: The image_url of this ModifyProductResult.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this ModifyProductResult.  # noqa: E501

        Product description  # noqa: E501

        :return: The description of this ModifyProductResult.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this ModifyProductResult.

        Product description  # noqa: E501

        :param description: The description of this ModifyProductResult.  # noqa: E501
        :type: str
        """
    ...
    @property
    def available(self):
        """Gets the available of this ModifyProductResult.  # noqa: E501

        Specifies if the product is available to be purchased  # noqa: E501

        :return: The available of this ModifyProductResult.  # noqa: E501
        :rtype: bool
        """
    ...
    def available(self, available):
        """Sets the available of this ModifyProductResult.

        Specifies if the product is available to be purchased  # noqa: E501

        :param available: The available of this ModifyProductResult.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModifyProductResult, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModifyProductResult):
            return False
