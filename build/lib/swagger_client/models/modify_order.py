...
class ModifyOrder(object):
    ...
    """
    swagger_types = {
        'replacements': 'list[ModifyOrderReplacements]',
        'removed_purchases': 'list[str]',
        'added_products': 'list[ModifyOrderAddedProducts]'
    }
    ...
    def __init__(self, replacements=None, removed_purchases=None, added_products=None):  # noqa: E501
        """ModifyOrder - a model defined in Swagger"""  # noqa: E501
        self._replacements = None
        self._removed_purchases = None
        self._added_products = None
        self.discriminator = None
        self.replacements = replacements
        self.removed_purchases = removed_purchases
        self.added_products = added_products

    @property
    def replacements(self):
        """Gets the replacements of this ModifyOrder.  # noqa: E501

        List of products to replace in the order  # noqa: E501

        :return: The replacements of this ModifyOrder.  # noqa: E501
        :rtype: list[ModifyOrderReplacements]
        """
        return self._replacements

    @replacements.setter
    def replacements(self, replacements):
        """Sets the replacements of this ModifyOrder.

        List of products to replace in the order  # noqa: E501

        :param replacements: The replacements of this ModifyOrder.  # noqa: E501
        :type: list[ModifyOrderReplacements]
        """
    ...
    @property
    def removed_purchases(self):
        """Gets the removed_purchases of this ModifyOrder.  # noqa: E501

        List of unique identifiers of purchased products (`purchased_product_id`) to be removed from the order   # noqa: E501

        :return: The removed_purchases of this ModifyOrder.  # noqa: E501
        :rtype: list[str]
        """
        return self._removed_purchases

    @removed_purchases.setter
    def removed_purchases(self, removed_purchases):
        """Sets the removed_purchases of this ModifyOrder.

        List of unique identifiers of purchased products (`purchased_product_id`) to be removed from the order   # noqa: E501

        :param removed_purchases: The removed_purchases of this ModifyOrder.  # noqa: E501
        :type: list[str]
        """
        if removed_purchases is None:
            raise ValueError("Invalid value for `removed_purchases`, must not be `None`")  # noqa: E501

        self._removed_purchases = removed_purchases

    @property
    def added_products(self):
        """Gets the added_products of this ModifyOrder.  # noqa: E501

        List of products to be added to the order  # noqa: E501

        :return: The added_products of this ModifyOrder.  # noqa: E501
        :rtype: list[ModifyOrderAddedProducts]
        """
        return self._added_products

    @added_products.setter
    def added_products(self, added_products):
        """Sets the added_products of this ModifyOrder.

        List of products to be added to the order  # noqa: E501

        :param added_products: The added_products of this ModifyOrder.  # noqa: E501
        :type: list[ModifyOrderAddedProducts]
        """
        if added_products is None:
            raise ValueError("Invalid value for `added_products`, must not be `None`")  # noqa: E501

        self._added_products = added_products
