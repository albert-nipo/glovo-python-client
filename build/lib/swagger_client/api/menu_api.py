...
class MenuApi(object):
    ...
    def upload_menu(self, content_type, store_id, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.upload_menu_with_http_info(content_type, store_id, **kwargs)  # noqa: E501
        else:
            (data) = self.upload_menu_with_http_info(content_type, store_id, **kwargs)  # noqa: E501
            return data

    def upload_menu_with_http_info(self, content_type, store_id, **kwargs):  # noqa: E501
        """Upload menu  # noqa: E501

        Allows you to upload or update the entire menu of a store in Glovo.  This process is asynchronous, so we will provide a `transaction_id` to follow the process with the [Verify menu upload endpoint](#operation/Verify-upload-menu)  <div align=\"center\">   <img alt=\"menu flow\" src=\"img/menu_update_process.png#center\" /> </div>  <div class=\"alert-box info\">   <i data-feather=\"info\"></i>   There is a maximum number of 5 of menu updates allowed per day per store address. For small products and attributes updates please use the individual or bulk endpoints. </div>  In case the limit is reached we will return status code 429 (too many requests).  If for some reason the Glovo system fails while updating, no changes will be made at all to avoid inconsistencies.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.upload_menu_with_http_info(content_type, store_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('content_type' not in params or
            ...
            raise ValueError("Missing the required parameter `content_type` when calling `upload_menu`")  # noqa: E501
        # verify the required parameter 'store_id' is set
        if ('store_id' not in params or
                params['store_id'] is None):
            raise ValueError("Missing the required parameter `store_id` when calling `upload_menu`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/webhook/stores/{storeId}/menu', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def validate_menu(self, **kwargs):  # noqa: E501
        """Validate menu  # noqa: E501

        Allows you to upload a menu and validate it against the current JSON schema definition. You will receive either an all-OK message or a list of errors and a list of warnings that the menu would generate along with details of the errors  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.validate_menu(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.validate_menu_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.validate_menu_with_http_info(**kwargs)  # noqa: E501
            return data

    def validate_menu_with_http_info(self, **kwargs):  # noqa: E501
        """Validate menu  # noqa: E501

        Allows you to upload a menu and validate it against the current JSON schema definition. You will receive either an all-OK message or a list of errors and a list of warnings that the menu would generate along with details of the errors  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.validate_menu_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='MenuValidationResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def verify_upload_menu_with_http_info(self, store_id, transaction_id, **kwargs):  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method verify_upload_menu" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'store_id' is set
        if ('store_id' not in params or
                params['store_id'] is None):
            raise ValueError("Missing the required parameter `store_id` when calling `verify_upload_menu`")  # noqa: E501
        # verify the required parameter 'transaction_id' is set
        if ('transaction_id' not in params or
                params['transaction_id'] is None):
            raise ValueError("Missing the required parameter `transaction_id` when calling `verify_upload_menu`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/webhook/stores/{storeId}/menu/{transactionId}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='MenuUploadStatus',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
