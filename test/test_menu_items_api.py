...
from swagger_client.api.menu_items_api import MenuItemsApi  # noqa: E501
...
class TestMenuItemsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = MenuItemsApi()  # noqa: E501

    def tearDown(self):
        pass

    def test_bulk_update_items(self):
        """Test case for bulk_update_items
    ...
    def test_verify_bulk_update_items(self):
        """Test case for verify_bulk_update_items
